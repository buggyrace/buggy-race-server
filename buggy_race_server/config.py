...
# ----------------------------------------------------------------------------
#
MANUAL_LATEST_VERSION_IN_SOURCE = "v3.1.5+dev"
#
# ----------------------------------------------------------------------------
...
class ConfigSettingNames(Enum):
    ...
    IS_STORING_RACE_ASSETS_IN_DB = auto()
...
class ConfigSettings:
    ...
    GROUPS = {
      ...
      ConfigGroupNames.RACES.name: (
        ...
        ConfigSettingNames.IS_STORING_RACE_ASSETS_IN_DB.name,
    ...
    DEFAULTS = {
        ...
        ConfigSettingNames.IS_STORING_RACE_ASSETS_IN_DB.name: 1,
...
""",
    ...
    TYPES = {
        ...
        ConfigSettingNames.IS_STORING_RACE_ASSETS_IN_DB.name: ConfigTypes.BOOLEAN,
    ...
    DESCRIPTIONS = {
        ...
        ConfigSettingNames.IS_STORING_RACE_ASSETS_IN_DB.name:
          """Race assets are image files used by the race player — in
          particular the background image (typically JPG) and the vector path
          stored as an SVG. If you create your own racetracks with custom assets,
          you can store them in the server's database if you choose `Yes`.
          Otherwise, you need to host them somewhere else with a friendly CORS
          policy (GitHub works fine).""",
    ...
    SETUP_GROUP_DESCRIPTIONS = {
      ...
      ConfigGroupNames.PROJECT.name:
        ...
        report/poster page to their buggy editor too?). They also cover things
        relating to _how_ you're running the project, including whether there
        is a submission date for your students, or if it's part of a module or
        course with a name or code you or the students use.""",
