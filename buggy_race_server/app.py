...
def create_app():
    ...
    def add_word_break_hints(config_name_str):
        ...
        return re.sub(r'([A-Z]_)([A-Z])', r'\1<wbr/>\2', config_name_str)
    
    app.jinja_env.filters['servertime'] = get_servertime
    app.jinja_env.filters['servertime_age_in_s'] = get_servertime_age_in_s
    app.jinja_env.filters['time_span'] = wrap_datetime_in_spans
    app.jinja_env.filters['with_word_break_hints'] = add_word_break_hints 
