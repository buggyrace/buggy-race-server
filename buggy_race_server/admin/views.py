...
def show_system_info():
    ...
    return render_template(
        ...
        is_db_uri_ssl_mode_required_key=ConfigSettings.DB_URI_SSL_MODE_REQUIRED_KEY,
        is_db_uri_ssl_mode_required=current_app.config[ConfigSettings.DB_URI_SSL_MODE_REQUIRED_KEY],
